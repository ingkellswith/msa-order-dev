...
public class ItemDto {
    ...
    public static class RegisterItemRequest {
        ...
        // 기본 매퍼 itemDto -> itemCommand
        // mapstruct 사용시 주의점
        // itemDto내의 collection요소, 즉 ItemOptionGroupDto -> ItemOptionGroupCommand 또한 interface에서 명세해줘야 함
        // 즉 item도메인에서 총 3개의 명세가 필요함
        // 1. ItemDto.RegisterItemRequest -> ItemCommand.RegisterItemRequest
        // 2. ItemDto.RegisterItemOptionGroupRequest -> ItemCommand.RegisterItemOptionGroupRequest
        // 3. ItemDto.RegisterItemOptionRequest -> ItemCommand.RegisterItemOptionRequest
    }
